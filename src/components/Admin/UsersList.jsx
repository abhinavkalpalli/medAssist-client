...
import { fetchPatients, blockUnblockPatient } from '../../services/admin/apiMethods';
...
function UsersList() {
  ...
  return (
    <div className="m-4">
      <h1 className="text-3xl font-bold mb-4" style={{ color: blueColor,textAlign:'center' }}>PATIENTS</h1>
        ...
        <Table aria-label="users table">
          ...
          <TableBody>
            {currentUsers.map((user) => (
              <TableRow key={user._id} style={{ backgroundColor: '#fff', '&:hover': { backgroundColor: '#f5f5f5' } }}>
